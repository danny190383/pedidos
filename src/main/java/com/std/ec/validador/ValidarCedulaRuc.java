...
@FacesValidator("validarCedulaRuc")
public class ValidarCedulaRuc implements Validator, ClientValidator {
    @Override
    ...
    public String getValidatorId() {
        return "custom.validarCedulaRuc";
    }

    public boolean validarCedulaRuc(String cedula_ruc)
    {
        boolean valor = true;
        try
        {
